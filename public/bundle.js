...
var reducer = function reducer() {
    ...
    switch (action.type) {
        ...
        case "DELETE_BOOK":
            ...
            break;
        case "UPDATE_BOOK":
            var curretBookToUpdate = [].concat(_toConsumableArray(state.books));

            var indexToUpdate = curretBookToUpdate.findIndex(function (book) {
                return book.id === action.payload.id;
            });

            var newBookToUpdate = _extends({}, curretBookToUpdate[indexToUpdate], {
